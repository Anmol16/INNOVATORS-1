    ...
    <div class="row">
      ...
      <div class="col-xs-12 col-md-3 col-md-offset-1">
        <div class="about-text">
          ...
          <p>Since 2009,India has made rapid strides in the health sector since independence. However, various eye opening data from NFHS clearly indicate that access to healthcare still remains a challenge.</p>
          <p>The need of the hour is thus a two pronged approach – first to bring quality healthcare services to doorsteps of the needy and second to promote healthcare awareness and contemporary healthcare seeking behavior among the underprivileged<a href="Aboutus.aspx">(................Read More)</a></p>
        </div>
      </div>
    </div>
  </div>
    ...
    <div id="row">
      <div class="col-md-6">
        <div class="col-md-10 col-md-offset-1">
          ...
          <p>So, lets take a step forward by helping those who are in need. Donating medicine not only help those who are in need but also the nature by decreasing the medical waste we see every year.</p>
          <p>No need of starting a movement or revolution. Just join hands with Helping Hand by Signing Up here and start the good work<a href="signup.aspx">(................Read More)</a></p></p>
        </div>
      </div>
      <div class="col-md-6">
